...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_data =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./data/solubility_train.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{janitor}\OperatorTok{::}\KeywordTok{clean_names}\NormalTok{()}
\NormalTok{test_data =}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./data/solubility_test.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{janitor}\OperatorTok{::}\KeywordTok{clean_names}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pred_lm_tr =}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit_lm_tr, test_data)}
\NormalTok{mse_test =}\StringTok{ }\KeywordTok{mean}\NormalTok{((pred_lm_tr }\OperatorTok{-}\StringTok{ }\NormalTok{test_data}\OperatorTok{$}\NormalTok{solubility)}\OperatorTok{^}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Hence, the MSE using test data is \texttt{mse\_test}.
